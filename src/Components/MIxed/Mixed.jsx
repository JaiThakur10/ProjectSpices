...
function Mixed() {
    const info = [
        { image: "images/chat.jpg", name: "Garam Powder Special", price1: 70, price2: 160,size1:200,size2:500},
        { image: "images/chat.jpg", name: "Mirch Pili Powder", price1: 45, price2: 90,size1:100,size2:200 },
        { image: "images/garam.jpg", name: "Sonf Powder", price1: 50, price2: 200,size1:100,size2:500 },
        { image: "images/jaljeera.jpg", name: "Jeera Powder", price1: 90, price2: 400,size1:100,size2:500 },
        { image: "images/chat.jpg", name: "Sonth Powder", price1: 70, price2: 320,size1:100,size2:500 },
        { image: "images/kitchen.jpg", name: "Daliya Packing", price1: 12, price2: 24 ,size1:120,size2:300},
        { image: "images/chicken.jpg", name: "Kasuri Methi", price1: 55, price2: 400 ,size1:50,size2:500},
        { image: "images/chicken.jpg", name: "Chat Masala", price1: 40, price2: 90 ,size1:200,size2:500},
        { image: "images/chicken.jpg", name: "Podana Chathi", price1: 180, price2: "" ,size1:1000,size2:""},
                ...
                <div className="flex mt-3">
                  <div className="mt-2.5 flex  space-x-2 min-[320px]:w-70">
                    <div className="  flex cursor-pointer justify-center items-center text-center rounded-md border-solid border-2 border-[#0097CC] mx-2 h-10 px-1 text-xs font-medium min-[320px]:text-xxs">
                      <h3>{info.size1}gm : MRP {info.price1}</h3>
