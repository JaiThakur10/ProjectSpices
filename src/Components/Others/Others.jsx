...
function Others() {
  const info = [
    ...
    { image: "images/soya_2.jpeg", name: "SoyaChunks ",s1: 'Rs 10/-',content:"Enjoy the hearty goodness of YPGold's Soya Chunks Moti. Packed with protein and nutrients, our Soya Chunks Moti is a versatile ingredient perfect for curries, stir-fries, and salads. With its tender texture and rich flavor, YPGold's Soya Chunks Moti adds wholesome goodness to your meals." },
    { image: "images/mini_soya_2.jpeg", name: "Mini SoyaChunks",s1: 'Rs 10/-',content:"Discover the versatility of YPGold's Soya Chunks Mini. Packed with protein and nutrients, our Soya Chunks Mini are perfect for curries, stir-fries, and snacks. With their small size and tender texture, YPGold's Soya Chunks Mini add wholesome goodness to every dish." },
