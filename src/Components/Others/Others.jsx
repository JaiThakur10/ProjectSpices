...
function Others() {
  const info = [
    ...
    { image: "", name: "Podana Chathi",s1: '1kg' ,content:"Podana Chathi is a versatile spice blend known for its aromatic and flavorful profile. It is often used in Indian cuisine to add depth and complexity to various dishes. This spice blend is prized for its ability to enhance the taste and aroma of curries, soups, stews, and grilled dishes. With its rich and fragrant qualities, Podana Chathi adds a delightful touch to any culinary creation."},
    ...
    { image: "images/soya_2.jpeg", name: "SoyaChunks Moti",s1: 'Rs 10/-',content:"Enjoy the hearty goodness of YPGold's Soya Chunks Moti. Packed with protein and nutrients, our Soya Chunks Moti is a versatile ingredient perfect for curries, stir-fries, and salads. With its tender texture and rich flavor, YPGold's Soya Chunks Moti adds wholesome goodness to your meals." },
    { image: "images/mini_soya_2.jpeg", name: "SoyaChunks Mini",s1: 'Rs 10/-',content:"Discover the versatility of YPGold's Soya Chunks Mini. Packed with protein and nutrients, our Soya Chunks Mini are perfect for curries, stir-fries, and snacks. With their small size and tender texture, YPGold's Soya Chunks Mini add wholesome goodness to every dish." },
