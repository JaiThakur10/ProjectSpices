            ...
            <div className=" flex items-baseline space-x-4 mb-0 m-auto ">
              ...
              <div className="dropdown dropdown-hover py-2 pr-4 pl-3 relative ">
                ...
                <ul tabIndex={0} className="dropdown-content z-[1] menu shadow h-[18rem] w-[22rem] bg-white-A700 grid grid-cols-2 gap-10 p-4 ">
                  <li className="w-28 h-[6rem] border border-solid border-gray-500 hover:bg-transparent focus:bg-transparent focus:outline-none"><NavLink to="https://www.flipkart.com/search?q=ypgold%20masala&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off"><img className="" src="images/flipkartlogo.png" alt="" /></NavLink></li>
